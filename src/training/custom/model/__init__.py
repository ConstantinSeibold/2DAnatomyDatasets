...
def get_model(model_name, n_classes=166, gpus=""):
    """
    ...
    model = model_getter[model_name.split("_")[0]](model_name,n_classes)
...
def get_unet(model_name, n_classes):
    """
    ...
    return BackboneUNet(model_name, n_classes)
