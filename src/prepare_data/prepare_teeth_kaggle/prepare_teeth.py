    ...
    for ann_file in tqdm(files):
        if ann_file.endswith('.json'):
            ...
            for obj in ann_data.get("objects", []):
                ...
                segmentation = [coord for point in points for coord in point]  # Flatten list of points
...
if __name__ == "__main__":
    ...
    shutil.move(os.path.join(teeth_root,"Teeth Segmentation JSON/d2/img"),os.path.join(teeth_root,"img"))
